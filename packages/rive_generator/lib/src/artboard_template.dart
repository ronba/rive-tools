...
class $mainRiveClassName {
  ...
  static final assetPath = '${riveInfo.assetPath}';

  $mainRiveClassName._(this.file);
  
  static Future<$mainRiveClassName> load() async {
    final riveFile = rive.RiveFile.import(await rootBundle.load('${riveInfo.assetPath}')); 
...
class RiveInfo {
  ...
  RiveInfo(this.name, this.assetPath);
